...
用途：保留原九曲的制作参数和选片历史。运行时已扩为 11 个 BGM 槽位；2026-09-06 三首新增素材已选剪接入，当前均有可播放文件，听感尚待签收，见 [选剪记录](review-archive/bgm-selection-2026-09-06.md)。下文九曲表、生成参数与 [缺曲补全单](udio-missing-bgm-prompts-2026-09-05.md) 的提示词作为制作历史，不代表当前账户参数或最新交付状态。
...
2026-09-05 更新：尚有 `live-call-allegro`、`pursuit`、`epilogue-dawn` 三首 planned，见 [缺曲补全单](udio-missing-bgm-prompts-2026-09-05.md)。可选 Outro 等尾声循环版入选后再做。
