...
| BROWSER-SMOKE | Playable route replay | `npm run smoke:browser` opens the offline playable and replays perfect, outer-then-core, and material-miss routes to the recap. | 离线包语法能过但真实按钮无响应、import alias 丢失、后台回流页崩溃，或材料误圈路线死路。 |
