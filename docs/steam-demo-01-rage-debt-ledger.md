...
| 债务 | 层级 | 发债 | 首期付息 | 持债上限 | 本金结清 | 下一笔债 |
|---|---|---|---|---|---|---|
| credit-lost-job-voice | Tier 1 | nightShell.prologue.coldOpen：“这次先帮我顶几天，我会还你的。” | nightShell.prologue.coldOpen（player-input）：玩家听完整条语音，最低还款金额随即出现，先前的同情开始动摇。 | 同一屏 | credit-loyalty-test:act2（player-input）：两次决定性指认后，判词拒绝替她做公开赦免。 | careChoices.accompany：“反正八万我不转，之前给我的就是主动赠与。” |
...
| 债务 | 层级 | 发债 | 首期付息 | 持债上限 | 本金结清 | 下一笔债 |
|---|---|---|---|---|---|---|
| work-profit-debt | Tier 1 | 04-workplace:opening：“怕影响后续给我活动” | work-private-process（player-input）：旧结算单说明主办能分到实支以外的款项。 | 第一夜 | work-split-ownership:act2（player-input）：费用草单与分配附注迫使他说明协调费没有外部服务。 | 04-workplace:caseClosing：“公司收入、押金和关联资金的实际关系” |
...
- 投放层级：Tier 2 → Tier 4
- Tier 4 资产：‘什么都不图’反转（第 2 案结束后可投放）——预判“她的低要求只是普通客套。”；反转“她可以拒绝陌生候选人，但仍希望主播先替她说可靠；主播因了解不足而拒绝。”
...
| quick1-low-standards | Tier 4 | low-standards：“一个月四五千就行，没房也可以。” | hidden-standards（player-input）：玩家问清经商和分担房贷是偏好，随后追问主播凭什么替她推荐。 | 第四轮内 | quick1:ending（player-input）：主播直说她想借自己的名字接触条件更好的人。 | quick1:ending：“她真正接受的择偶条件仍未全部说清。” |
...
| quick2-rare-night-out | Tier 1 | missed-message-version：“我已经很久没出去了。” | nightlife-pattern（player-input）：玩家对照朋友圈，追出近两个月六次夜场和连续两晚外出。 | 第四轮内 | quick2:ending（player-input）：主播直说她把长期生活状态说成一次偶然。 | quick2:ending：“酒桌上有没有发生别的事，不用猜。” |

## 快案｜03-labeled-fiction｜写给女演员的长文
...
| quick3-public-leverage | Tier 2 | early-rumor：“网上已经出现代孕传闻。” | settlement-inference（player-input）：玩家可以先说求和推断为什么可信，再由主播补上本人授权仍缺材料。 | 第三段内 | quick3:ending（player-input）：主播把有依据的推测与已经确认的公开动作分开，再给出个人结论。 | quick3:ending：“但有依据的推测仍不是本人授权。” |
