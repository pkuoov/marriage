...
|---|---|---|---|---|
| 林旭阳 | host | 温热、有分寸，也有明确好恶 | 事实没闭合时先缩短句子，把混在一起的事拆开；证据已经对齐，对方还在把自己的代价甩给别人时，他会收笑、直说，火气只落在具体做法上。 | 平时稳、短，关键处停一下；真正动怒时不用分栏句，改用第二人称、具体动作和短句当面说。；X归X，Y是Y；先别定；把这两件事分开；这个忙我不帮；我们不脱离感情只谈钱 |
...
- **press Response：** 她抢着补了一句：‘餐厅和礼物本来就是两个人用的。’再问每月那笔，她没接。
...
- **press Response：** 她先说‘灯现在还在我家’，说到分期，又马上补：‘可不是我签的。’
...
- **press Response：** 她咬住‘八万不是我的卡’，再问以前的钱，只回了一句：‘那是以前。’
...
- **press Response：** 她说：‘我没给他看过余额。’停了一下，又补：‘他自己猜的。’
...
- **press Response：** 她话到一半收住，只肯说：‘反正今晚我不转。’
...
**咨询者：** 等等。17500，十四个月，这个我认。七月没来，我那天也问了他好几次。可那是因为他又瞒事，不是我每个月等着这笔钱。
...
- **split After：** 2
- **mid Summary：** 她认了钱一直来，也认了七月追问，剩下只往动机上躲。别替她猜，听她自己怎么说。
###### relief Beat
...
- **press Response：** 她马上接话：‘我问的是他为什么又撒谎。’至于钱没来，她绕开了。
...
- **press Response：** 她只重复‘卡不是我的’，以前的固定转账一句没接。
...
- **press Response：** 她把声音压低：‘这数我只跟当事人说。’再多一句都不肯。
...
- **press Response：** 她先认下自己用的东西，提到信托又立刻把话推回他那边。
...
- **press Response：** 她马上说：‘图上就是审批通过。’再问报销编号，她没念出来。
...
- **press Response：** 她数了一遍：‘三次，都是 LX 那张。’问有没有新编号，她说没有。
...
- **press Response：** 她很快接话：‘这个负责人是我争来的。’说到刷卡，声音就低了。
...
- **press Response：** 她把两个字段重新念了一遍，念到自己的信用卡时停了。
...
- **press Response：** 她说：‘消息还在输入框。’问为什么不发，只回：‘怕以后没活动。’
...
- **press Response：** 她抢着说：‘他就是这么答应我的。’问到群公告，她停了一拍。
...
- **press Response：** 她说：‘对，三张一样。’至于为什么没问编号，只回了句‘我当时信了’。
...
- **press Response：** 她先护住负责人署名：‘这个别给我撤。’又补：‘可卡也不能一直压我这儿。’
...
- **press Response：** 她把两个词念得很慢：‘报销编号，预计日期。明天我就问这两个。’
...
- **stage Judgement：** ‘流程都走完了’是假话。你手里只有立项页，没有报销编号，也没有回单。他拿‘来不及’催你垫卡，三个星期只发这张旧图，就是看准你想表现。六万八不是你捐的。明天带发票走正式报销；这单靠你个人垫钱和层层返费往前走，不是财务慢。每笔返费进了谁的账户，今晚不知道。
### quote Pick Candidates
...
- **press Response：** 她马上补：‘MBA 确实在那里读。’再问本科，她没接。
...
- **press Response：** 她说：‘别的账户我没见过。’说完又把二十八万六念了一遍。
...
- **press Response：** 她念到‘进我卡’时停了一下，婚宴和首饰说得很快。
...
- **press Response：** 她低声补了一句：‘我爸原话就是给我留着。’
...
- **press Response：** 她说完‘给我留着’，马上又补：‘可这也算我家出钱吧。’
...
- **press Response：** 她立刻说：‘就差两千。’再问这两千怎么等于态度，她声音小了。
...
- **press Response：** 她说：‘对，别的我不知道。’可下一句又绕回这张工资卡。
...
- **press Response：** 她把条件重新念了一遍，没有再说男方答应过。
...
- **press Response：** 她只说：‘九月底，还没到。给我留着。’
...
- **press Response：** 她立刻说：‘那排名字就是全是女的。’问到右边的钱，她停了。
...
- **press Response：** 她停了几秒，才补：‘我后来确实问过 Tony，能不能让我跟着买。’
...
- **press Response：** 她重复了一遍：‘钱是我转的。可他收了以后，合同呢？’
...
- **press Response：** 她先说‘我不想被围着骂’，再问为什么裁得这么齐，她没否认。
...
- **press Response：** 她把声音抬高：‘他就是拿谈恋爱收的钱。’问是谁先说帮买，她没答。
...
- **主播台词：** 名单右半边写得很清楚：十二万，不够一百万起投，走 Tony 户。是你先开口让他帮你买，不是他借恋爱偷划。把这十二万全改口成恋爱诈骗，这个说法我不认。
...
**咨询者：** 你听我——行，十二万是我自己问了以后转给他的，我让他帮我买，这一步我认。可那天店里一直在说高息档，Tony 又说机会难得，我当时真不好意思说不跟。
...
- **split After：** 2
- **mid Summary：** 她认了是自己开口，却把一百万门槛说成 Tony 在店里才塞给她的念头。顺序得重新对。
...
- **标签：** 改口 01
是我先问他能不能帮我买。可那天不跟，好像就我一个人不识货。转钱以前，没人认真跟我讲过一百万门槛。

- **press Response：** 她急着说：‘那种场面你不在。’再问小姐妹早先说过什么，她只回‘随口聊过’。
...
- **press Response：** 她点了两次头：‘这两句都是我发的。’再往后，她只问合同在哪。
...
- **press Response：** 她把话压回原件：‘我只要产品名、合同、回单。’
...
- **press Response：** 她顿了一下：‘这点我不躲。’可名单上的‘自己人’，她还是要 Tony 解释。
...
- **selection Reason：** 第一段里她亲口承认，转钱前小姐妹已经提过一百万起投。把这句原话放回第二段，能打穿‘转钱前没人讲过门槛’的新框架；同时保留 Tony 的关系暗示和资金去向责任。
###### material Cards
...
- **咨询者台词：** 小姐妹先提过一百万。我当时……算了，我后来又去问 Tony。这一步不能全推给店里的气氛。
...
- **提示题：** 这段说明里，哪一句最该拎出来？
- **材料：** 店长说：“我们店只做美发，也没让员工替客人收这种钱。Tony 私下跟客人说了什么，你们问他本人，别把店也写进去。”
##### 材料行
...
十二万过到我户没错，可先问能不能跟着买的是她。我说过走我户，也说过已经提交。名单就是我记客户的，不是什么女朋友名册。‘自己人’我叫过，晚档我也留过，怎么了？产品名、合同、回单我会给她本人，不给直播间。我不上麦。
...
‘自己人’这三个字，我以前上班时也听过。通常下一句就是‘这次你先帮我’。所以这张表，我还得往下问。
...
**林旭阳：** 一百万的出资人不是亲爸，你又不肯说关系。我不能替你把家境说成清楚。那你自己愿意见什么样的？
...
**林旭阳：** 给你一百万的不是亲爸。你主动拿自己不能生孩子举例，问回去才承认做过检查。你让我从认识的人里替你介绍，这个忙我不能帮。
...
**林旭阳：** 我判断，她这通电话不只是问择偶定位，是想借我的名字接触条件更好的人。她先说月薪四五千、没房也行，普通对象递到面前又不接，转头要经商、家里省心，最好还能分担房贷；同时还想让我先替她说人可靠。这个背书我不能做。
