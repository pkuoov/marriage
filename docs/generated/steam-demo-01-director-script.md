...
- **性格 / 防御：** 敏感的体面维护者；先把半薪说成男方自愿给花的。代存聊天出现后，承认说过存着，仍拿他以前没拦过消费来反问；承认拿不出八万，却拒报当前余额。
...
【玩家怀疑方向】所以你觉得，以前转给你的钱，他现在就不该往回要？
...
- **性格 / 防御：** 把家里的婚恋规矩当成常理，重保障和面子，不觉得自己的要求需要逐条争取同意。；先说彩礼是母亲定的，把家境调查说成父母替她操心；只转达金额，不说付款时点、收款账户和额外支出，也不主动计算男方已经承担的饭钱、展票、接送和倾听。
- **受压变化：** 更爱报精确数字、减少语气词；问到自己的八万四和父母那笔理财时句子骤短。
- **跨幕：** 夜 A｜报学历、学费和彩礼数字，强调二十八万八是母亲定的，暂不说自己知情后没有叫停。 白天｜逐句标出介绍人传过什么，承认父母查到普通家境后没有喊骗，而是借自费 MBA 和出身落差加价；家里群露出领证前进个人账户、婚宴首饰另算和父母二十万元留给女儿。 夜 B｜男方上麦后争付款条件；她先说自己也会出钱，追问才报八万四、六万上限与婚后用途，双方再争父亲的钱和婚宴由谁承担。 结案｜饭局取消，她要求男方向介绍人说他忙，被拒绝后仍未答应改付款条件。她继续争取对外解释，不能突然接受教育、把未谈妥写成和解。
...
- **跨幕：** 夜 A｜只给名单左半边；追问后承认右边记钱但不交原图，讲恋爱与听过高收益，产品明细、起投数和走户安排留到次日材料。强光敲门后下线。 白天｜店门口听见自己人也对别人说；小姐妹只肯说酒桌门槛，柜员只讲认购规则。完整名单与转账对到十二万时，她仍想把代投说成被骗。 夜 B｜回拨先确认安全，敲门警察与借款短交代；必经追问说明她听到赎回拖延才翻手机，并带出酒吧营销与小姐妹消息。随后集中问出不够起投、主动走他户代买；周的客户身份单独核对。 结案｜继续追产品全名、合同、回单和下单账户，取消后续预约。保留真实恋爱和照顾；不因主动代投替Tony排除误导。
