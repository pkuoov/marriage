...
- `$case.sceneVersions[6].questionOptions[0].question` 你听完就把转账页点开了。账单还有三天才到期，你现在为什么还想转？
...
- `$case.deepFollowup.question` 那我换个问法。信用卡这八万里，哪些钱你愿意跟他坐下来谈？
...
- `$case.overnightStructure.returnBeat.lines[0]` 昨晚那三万五还没说清。我们从这儿接着问。
