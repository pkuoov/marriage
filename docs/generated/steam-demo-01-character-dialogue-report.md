...
- `$quick.turns[0].host` 你好，听得见吗？
- `$quick.turns[1].host` 好，你说，想问什么？
- `$quick.turns[2].host` 你们现在谈的是哪些钱？
- `$quick.turns[3].host` 你跟老张在一起多久了？
- `$quick.turns[4].host` 孩子现在跟着你住？
- `$quick.turns[5].host` 那三百万元是怎么算的？
- `$quick.turns[6].host` 他拿到你那张表以后怎么说？
- `$quick.turns[7].host` 你说也跟小张谈过，是怎么开始的？
- `$quick.turns[8].host` 他在邻市，你们平时怎么见面？
- `$quick.turns[9].host` 两边的生活费怎么付？
- `$quick.turns[10].host` 小张一直拿着的那份报告，你这里有完整的吗？
- `$quick.turns[11].host` 当时是谁帮你联系的？
- `$quick.turns[12].host` 你说老张还有一份，找到了吗？
- `$quick.turns[13].host` 后来这张纸放在哪儿？
- `$quick.turns[14].host` 你说一直听初恋解释，他当时怎么跟你说的？
- `$quick.turns[15].host` 这段聊天往前还能翻到吗？
- `$quick.turns[16].host` 小张现在听到你怎么解释？
- `$quick.confrontations[0].lines[0]` 你们没领证，先分你二百万，是根据什么？
- `$quick.confrontations[0].lines[2]` 你照顾过他，我听见了。你说他答应安排住处，有没有把房子过到你名下？
- `$quick.confrontations[0].lines[4]` 那张分配表是谁写的？
- `$quick.confrontations[0].lines[6]` 照顾的事可以拿材料去谈。可你自己写的方案，还不能叫已经属于你的二百万。
- `$quick.confrontations[1].lines[0]` 老张那时候还活着，为什么采的是小张的样本？
- `$quick.confrontations[1].lines[2]` 小张当时想查自己跟孩子是什么关系？
- `$quick.confrontations[1].lines[4]` 他是想查自己是不是孩子的父亲吗？
- `$quick.confrontations[2].lines[0]` 备注写着儿子奶粉钱，你怎么说跟孩子是谁的没关系？
- `$quick.confrontations[2].lines[2]` 他说给儿子买点好的，你怎么回？
- `$quick.confrontations[2].lines[4]` 你有没有跟他说，别先把自己当孩子爸爸？
- `$quick.confrontations[2].lines[6]` 可小张是在养他以为的儿子。你不能把这个前提抹掉，只剩他愿意。
- `$quick.confrontations[3].lines[0]` 不能据此判断是否为父子，这句小张看见过吗？
- `$quick.confrontations[3].lines[2]` 有血缘是一回事。他问的是亲生儿子，这份报告自己都说不能判断。完整的那页，你给过他吗？
- `$quick.confrontations[4].lines[0]` 你说老张去世才知道，可去年四月十七日，你已经跟初恋说老张那张支持父子了。
- `$quick.confrontations[4].lines[2]` 纸在谁手里可以另说。四月十七日这句话是你发的吗？
- `$quick.confrontations[4].lines[4]` 所以五月给小张那张截图以前，你已经知道孩子是老张的，对吗？
- `$quick.confrontations[4].lines[6]` 他已经买了东西，你就更该告诉他。你让他继续当爸爸，继续给钱，拖到老张去世才改口。
- `$quick.confrontations[5].lines[0]` 你说不知道为什么只留一行，可聊天里，是你问他能不能只留有血缘那行。
- `$quick.confrontations[5].lines[2]` 我问的不是这笔费。把不能认父子的说明去掉，是不是你的要求？
- `$quick.confrontations[5].lines[4]` 裁完以后，谁发给小张的？
- `$quick.ending.summaryPages[0].lines[0]` 你要那段说三百万都该给你的录音，我不会给。你把完整报告、聊天和收款记录带去，别再只挑对你有利的一行。
- `$quick.ending.summaryPages[0].lines[2]` 孩子是谁的，你早就知道。老张活着，你拿那份报告骗小张当爹、给你钱；老张刚走，你又要当小张的后妈，张口拿走四分之三。每次换说法，你都想多拿一笔钱。你就是个为了钱不择手段的骗子，别再拿孩子给自己挡着。
- `$quick.ending.summaryPages[0].lines[4]` 孩子该有的权益，不能因为你撒谎就抹掉。你也不能把孩子的那份当成自己的钱。明天谈孩子的事，把孩子的材料带齐；你自己的主张，也拿你自己的依据。
- `$quick.ending.summaryPages[1].lines[0]` 我们来把这次这个连线复个盘。
- `$quick.ending.summaryPages[1].lines[1]` 动作倒推发心，逻辑要闭环。她开头说的是母子被排斥，后来给出的材料，却把她自己的话一层层拆开了。
- `$quick.ending.summaryPages[1].lines[2]` 第一张分配表是她写的。没登记，没过户，也没有遗嘱，却先把四百万里的二百万划给自己。这个算法没有被那几句生活上的照顾证明。
- `$quick.ending.summaryPages[1].lines[3]` 第二处是小张的转账。他写儿子奶粉钱，她收了，也没有纠正。他看到的图只剩有血缘，完整报告上不能判断父子的话被截掉了。
- `$quick.ending.summaryPages[1].lines[4]` 最后是日期。四月十六日老张的报告出来，十七日她就在聊天里说支持父子；五月十八日才把另一份截图给小张。不是因为报告出得早，我就猜她早知道，是她自己发过的话证明她知道。
- `$quick.ending.summaryPages[2].lines[0]` 她既知道孩子是谁的，又主动要求裁掉说明，还承认不想小张停掉每月三千。这三件事放在一起，我判断，她一直在挑对自己能拿钱的说法。今晚又想借我的一句话，把自己写的分配表变成别人不好拒绝的要求。
- `$quick.ending.summaryPages[2].lines[1]` 关系和财产还得分别查。只凭同居，不能按她的算法先划走一半；亲子材料、财产权属、是否存在其他有效安排，都要拿原件去谈。照顾付出能支持什么主张，也应当单独核实。
- `$quick.ending.summaryPages[2].lines[2]` 孩子的继承权益要依法处理，代管也不等于钱归母亲。小张过去给的钱如何处理、初恋该担什么责任，今晚没有问到足够材料。我不会替他们在直播间报一个最终分账数。

## 快案来电人·女秘书

- **固定性格：** 会用照顾和孩子的需要包装利益要求，遇到细节就缩小自己责任的人
- **受压反应：** 先用一起生活的细节争取理解，再强调别人自愿；被日期和原话卡住后先推给初恋，最后只承认没法再否认的那一步。
- **防御动作：** 把不同概念挪在一起说：同居和结婚、亲缘和父子、代管和所有；退路依次是没改字、别人帮忙、别人自愿、孩子需要。
- **知识边界：** 知道孩子是老张的，知道两段关系重叠、两份报告的区别和自己请求裁图的经过。知道自己与初恋的往来，不知道初恋接触机构的全部流程，也不能代表小张确认每笔转账的法律性质。两张报告在游戏中是她主动提供的材料，主播不能只凭立绘得出任何事实。

### 其他出声面

- `$quick.turns[0].caller` 主播，我在孩子房门外，可能说话轻一点。
- `$quick.turns[1].caller` 我想问问遗产。我跟的那个人，叫他老张吧，三个星期前车祸没了。他大儿子现在翻脸了。我和孩子拿四分之三，他都不肯。我不是要把他赶出去，总得让我们母子以后能过日子。
- `$quick.turns[2].caller` 存款加一套房，扣完说好的债，一共四百万。这张清单我和小张都看过，是老张个人留下的。他五十八，前妻去世很多年了，那时候的遗产已经分清。他父母也早没了，就小张和我这个孩子，没有别的孩子。没找到遗嘱。明天家里约了第一次见面谈，小张非要我把报告和转账都带去。
- `$quick.turns[3].caller` 我跟老张在一起三年。我原先给他做秘书，后来就在一起了。他说公司里闲话多，先别公开。我们没领证，可衣服、药，家里这些东西都是我收。不能就因为少一张证，把我当外人吧。
- `$quick.turns[4].caller` 孩子现在跟我住，刚满一岁半。我三十二，之前还能上班，现在接送、看病都是我来。白天请个钟点工搭把手。老张说过会给我们安排住处，我一直记着这句话。
- `$quick.turns[5].caller` 四百万先分一半给我，剩下两百万，两个儿子一人一百万。孩子这份也得我管，我跟孩子合起来就是三百万。我把这个写成表了，小张只要签个字就行。我想他叫我一声后妈，也不算占他便宜。
- `$quick.turns[6].caller` 他不签，说孩子到底是谁的得先讲清。我有报告啊，上面写有血缘关系。那份是去年五月十八日拿的，孩子两个月，采的是小张和孩子的样本。老张那时候还好好的，一家人，查谁还不都一样。小张现在偏要我拿完整的。
- `$quick.turns[7].caller` 小张二十九，留学回来以后去邻市工作，来公司时认识我的。我一开始就知道他是老张的儿子。跟他好了两年半吧，他以为我只是他爸的秘书。我说公司里不能谈办公室恋爱，让他先别告诉家里。老张那边，我也没提。
- `$quick.turns[8].caller` 我在老张那儿住，小张回国后在邻市租了房，我也常过去住。跟老张说去邻市办事，跟小张说回公司上班。后来生了孩子，两边跑得少些。孩子坐车容易闹，我都是等他睡着才出门。两边都没领证。
- `$quick.turns[9].caller` 老张每月给一万，小张每月三千。我把小张那几笔截图发后台了，备注是他自己写的：儿子奶粉钱。他有时候还说给儿子多买点好的。钱是他们自愿给的，跟孩子到底是谁的没关系，又不是我挨个伸手要。
- `$quick.turns[10].caller` 小张手里那份报告，完整的我也找到了，发过去。抬头叫亲缘筛查，下面写两份样本提示存在亲缘关系，再下面还有句不能据此判断是否为父子。小张收到的那张只有有血缘那行，字可一个没改。他问是不是亲生的，我说报告都出了，还能有假吗。
- `$quick.turns[11].caller` 当时是我初恋帮忙联系的。他在一家医疗咨询公司做转介，不是出报告的鉴定人。分手好多年了，早没那种关系了，也不可能是孩子的爹。我问怎么查，他说他熟。我当时觉得，有血缘就能说明问题，是他把这个给办歪了。
- `$quick.turns[12].caller` 老张跟孩子的另一份报告，我也找到了。刚才手机里搜不到，我把纸翻出来拍给你。上面是老张跟孩子，结论写支持生物学父子关系。出报告是去年四月十六，孩子刚满月那会儿，我们三个一块去采的样。老张要留一份，他说心里踏实。
- `$quick.turns[13].caller` 这份报告原来放在老张书房的抽屉。我现在把两份都塞孩子的检查袋里，明天一起带过去。报告是出得早，可当时是老张收的。我也是他去世以后才知道孩子是他的，之前总听那个初恋在解释。你不能拿一张早出的纸，就说我早知道。
- `$quick.turns[14].caller` 那个初恋跟我说可以办，我给过钱的，去年五月十八，八千块，转账备注是咨询加急费。我连这段聊天也发你了。不能钱让他收了，出了事全算我头上。截图是他自己裁的，我都不知道他为什么只留那一行。
- `$quick.turns[15].caller` 我把同一个聊天往前翻，前面那屏也发过去了。去年四月十七，我问他：老张那张写了支持父子，小张这张能不能只留有血缘那行。他回：等结果，真有这行可以截，不能拿它认父子。可我那时候是问怎么解释，又没叫他改字。他要是不答应，我也办不成。
- `$quick.turns[16].caller` 老张去世以后，我告诉他孩子是他弟弟。他把以前的聊天全翻出来了，说跟我结束，还让我明天当着大家讲。我现在讲给你听了，你能不能把母子该拿三百万那段单独留给我？明天放给他们听，省得他们又拿孩子说事。
- `$quick.confrontations[0].lines[1]` 三年啊。他衣服放哪儿我都知道，生病也是我给拿药。我做的跟老婆有什么区别？
- `$quick.confrontations[0].lines[3]` 还没有。他总说过阵子，谁知道会出事。
- `$quick.confrontations[0].lines[5]` 我写的。没有遗嘱，小张也还没签。我就是先提个方案，照顾他这么久，总不能一点都不算。
- `$quick.confrontations[0].lines[7]` 行，我说应得，说早了。可孩子那份总不能不给。
- `$quick.confrontations[1].lines[1]` 他们是一家人，孩子跟小张有血缘，不就说明是张家的孩子？
- `$quick.confrontations[1].lines[3]` 这跟现在分遗产有关系吗？我又没说孩子是外面抱来的。
- `$quick.confrontations[1].lines[5]` ……是。他那时候觉得孩子是他的。我也跟他谈过，这个我刚才没说。
- `$quick.confrontations[2].lines[1]` 我又没拿着手机逼他转。他愿意对孩子好，那也是感情。
- `$quick.confrontations[2].lines[3]` 我一般回收到了，谢谢。有时候发张孩子的照片。
- `$quick.confrontations[2].lines[5]` 没有。他高高兴兴的，我没去打断。老张的钱也照常给，我又没拿两份工资，都是过日子。
- `$quick.confrontations[2].lines[7]` 那你让我怎么说。他当时也看过报告，又不是光听我一句。
- `$quick.confrontations[3].lines[1]` 他看到的字也是真的啊。谁跟谁没关系，能查出来有血缘吗？
- `$quick.confrontations[3].lines[3]` ……没给。我发的是初恋裁好的那张。可老张也有一份，那个说得很清楚，我找给你，省得你以为我连孩子是谁的都在乱讲。
- `$quick.confrontations[4].lines[1]` 那也可能是老张跟我说的。我没把纸放在自己手里，谁记得那么清楚。
- `$quick.confrontations[4].lines[3]` 是我发的。我没说聊天是假的。
- `$quick.confrontations[4].lines[5]` ……对。四月就知道了。可那时候小张连婴儿床都买好了，我怎么突然跟他说？
- `$quick.confrontations[4].lines[7]` 我承认我拖了。可我一个人带着孩子，你说实话，我当时能怎么办？
- `$quick.confrontations[5].lines[1]` 八千块是咨询加急费，不是让他造假。别一说给钱就变味。
- `$quick.confrontations[5].lines[3]` 是我问的。实际动手是他，他要说不行，我也没办法。
- `$quick.confrontations[5].lines[5]` 我。行，是我发的。我就是不想他再问，也不想他把每月那三千停了。总不能让孩子跟着吃苦吧。
- `$quick.ending.summaryPages[0].lines[1]` 我只是想以后有个保障。
- `$quick.ending.summaryPages[0].lines[3]` 那你这段播出去，明天他们还肯给孩子钱吗？
- `$quick.ending.summaryPages[0].lines[5]` ……知道了。我先挂了。
