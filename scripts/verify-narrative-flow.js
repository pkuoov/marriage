...
import { generateCasesForMode } from "../src/caseModes.js?v=0.20.60";
import { explanationForExpected } from "../src/caseNarration.js?v=0.20.60";
import { expectedAccusationForCase } from "../src/caseRuntime.js?v=0.20.60";
