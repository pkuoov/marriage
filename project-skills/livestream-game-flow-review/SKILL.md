...
5. Validate mechanically.
   ...
   - Run `npm run smoke:browser` after playable flow, bundler, route, material, recap, input focus, or content-pack runtime changes. It must cover perfect, outer-then-core, material-miss, and keyboard-perfect routes.
