import { applyDifficultyProfile } from "./difficulty.js?v=0.20.41";
import { DEFAULT_STORY_PACK_KEY, storyPackCaseCount, storyPackForKey } from "./storyPacks.js?v=0.20.41";
