import { normalizeCaseMode, validCaseBriefCount } from "./caseModes.js?v=0.20.57";
import { activeSaveSlot, saveStore } from "./platform/saveStore.js?v=0.20.57";
...
export const CHARACTER_ART = {
  meng: "./assets/generated/characters/meng_host_v2.png?v=0.20.57",
  zhou: "./assets/generated/characters/zhou_neutral.png?v=0.20.57",
  lin: "./assets/generated/characters/lin_neutral.png?v=0.20.57",
  xu: "./assets/generated/characters/xu_neutral.png?v=0.20.57",
  chen: "./assets/generated/characters/chen_neutral.png?v=0.20.57",
  shen: "./assets/generated/characters/shen_neutral.png?v=0.20.57",
  he: "./assets/generated/characters/he_neutral.png?v=0.20.57"
};
