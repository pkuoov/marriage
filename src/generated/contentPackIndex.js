...
export const CONTENT_CASES = {
  "steam-demo-01": {
    "01-credit": {
      ...
      "openingComplaint": "咨询者连线说：“我男朋友前几天突然让我帮他垫信用卡，说是短期周转。可我后来对账单才发现，这个窟窿早在他借钱之前就有了……”",
      "openingDialogue": [
        {
          "speaker": "咨询者",
          "role": "caller",
    ...
    "02-tony": {
      ...
      "openingComplaint": "咨询者连线说：“我和相亲认识的一个发型师暧昧了几个月，本来以为快要往前走一步了。结果他昨晚发错一张店里的内部表，我越看越觉得，那上面记的不是预约时间。”",
      "openingDialogue": [
        {
          "speaker": "咨询者",
          "role": "caller",
      ...
      "investigationHooks": [
        {
          ...
          "prompt": "这张同款表里，哪处最该圈？",
          "material": "她那栏写着“能投店”，后面跟着“约见朋友、聊分红”。另一栏写“情绪稳住，年卡下次推”。那位朋友后来补了一句：她待过的店也有维护表，备注顶多写发型和预算，从没见过“下一次推进”这种列。",
    ...
    "04-workplace": {
      ...
      "stageJudgement": "前三通都是把好处藏到最后，这通咨询者开场就认了。所以别问咨询者藏了什么，问那两条钱路为什么都过对方的手。",
